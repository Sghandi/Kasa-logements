...
const Collapse = (props) => {
  ...
  const toggleClass = open ? 'toggle2 open' : 'toggle2';
  return (
    <div>
      <button className="collapse-button2" onClick={toggle}>{props.label}{' '}
      <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg" className={open ? 'rotate-icon2' : ''}>
